...
<template>
  <form @submit.prevent="createWebApp" class="flex flex-col">
    ...
    <div class="flex items-center mb-4 mt-4">
      <input disabled checked id="disabled-checkbox" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" />
      <label for="disabled-checkbox" class="ms-2 text-sm font-medium text-gray-400">Use Documents folder as default folder</label>
    </div>
